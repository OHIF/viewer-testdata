...
| Study Instance UID | Directory | Source / notes |
|--------------------|-----------|----------------|
| `1.2.826.0.13854362241694438965858641723883466450351448` | `Dummy/` | Synthetic test study (patient name “Dummy”); retrieved via DCM4CHEE for local testing (`dcm/README.md`). |
| `1.3.12.2.1107.5.2.32.35162.30000015050317233592200000046` | `FreeSurferSeg/` | Anonymized MR with segmentation objects for viewer testing. |
| `2.16.840.1.113662.2.1.1519.11582.1990505.1105152` | `image-types/` | Medical image samples (multiple transfer syntaxes / bit depths). https://barre.dev/medical/samples/ (see also DCMTK wiki: https://support.dcmtk.org/redmine/projects/dcmtk/wiki/DICOM_images) |
| `1.3.6.1.4.1.25403.345050719074.3824.20170125113417.1` | `Juno/` | Color photograph DICOM samples with NIfTI segmentations for overlay/segmentation testing. |
| `1.2.840.113619.2.5.1762583153.215519.978957063.78` | `MisterMr/` | Structured report and presentation state examples. |
| `2.25.96975534054447904995905761963464388233` | `mixedVideo/` | Horse eye images and video — see citation above. |
| `1.3.46.670589.30.1.3.1.1625260923.1632320482484.1` | `overlay/` | Test data with compressed overlays (JPEG-LS). |
| `1.2.840.113654.2.55.242841386983064378162007136685545369722` | `scoord3d-and-scoord/` | Spatial coordinates (SCOORD / SCOORD3D) annotation examples. |
| `1.2.276.1.74.1.2.132733202464108492637644434464108492` | `sm/` | Anonymized whole slide microscopy (SM) for OHIF viewer testing (`dcm/sm/README.txt`). |
| `1.3.76.13.65829.2.20130125082826.1072139.2` | `anonymous_ecg.dcm` | Anonymized 12-lead ECG waveform — see citation above. |
| `2.25.317377619501274872606137091638706705333` | `roadmap.dcm` | XA roadmap / multi-frame test object. |
